  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center space-x-4">
        ...
        <div>
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white">New Material</h1>
          <p className="text-gray-600 dark:text-gray-300">Create a new material entry</p>
        </div>
      </div>
